// SPDX-License-Identifier: MIT
 ...
 contract Voting is Ownable {
     ...
     function addAddressToWhitelist(address _address) public onlyOwner isNotWhitelisted(_address) hasStatus(WorkflowStatus.RegisteringVoters) {
     ...
     function showWinningProposal() public view hasStatus(WorkflowStatus.VotesTallied) returns (uint) {
